let rules = `muted lime bags contain 1 wavy lime bag, 1 vibrant green bag, 3 light yellow bags.
...
dim magenta bags contain 1 dark maroon bag, 3 dull olive bags, 5 dim tomato bags, 5 wavy gold bags.`.split('\n');
rules = rules.map(e => {
    return e.split(" ")
})
...
//console.log(checkGold(rulesObj))
